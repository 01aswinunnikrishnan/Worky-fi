...
<head><h1 align="center">Customer Verification</h1>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Customerverification</title>
</head>
<body>
<?php
  	...
  	if($con->query($del))
			...
			?>
					...
					<script>
							...
							window.location="CustomerVerification.php";
					</script>
           <?php
...
?>
  ...
  <table border="1" align="center" cellpadding="10">
    <tr>
     ...
     <?php
	$sel="select * from tbl_customer c inner join tbl_place p on c.place_id=p.place_id inner join tbl_district d on d.district_id=p.district_id inner join tbl_state s on s.state_id=d.state_id where c.status='0'";
	$row=$con->query($sel);
	$i=0;
    ...
    <tr>
      ...
      <td><img src="../Assests/WorkerPhoto/<?php echo $data["customer_photo"];?>" width="120" height="120" /></td>
       ...
       <td> <a href="CustomerVerification.php?rejid=<?php echo $data["customer_id"]?>"><img src="../Assests/Icons/reject2.png" width="100" height="60" id="rej1" onMouseOver="mouseOverr()" onMouseOut="mouseOutr()" ></a>
       </td>
    </tr>
    <?php
	}
