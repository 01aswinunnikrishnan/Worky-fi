...
<body>
    ...
    <div class="container-fluid bg-dark px-0">
        <div class="row g-0 d-none d-lg-flex">
            ...
            <div class="col-lg-6 text-end">
                ...
                <span class="fs-5 fw-bold me-2"><i class="fa fa-star me-2"> <i class="fa fa-star me-2"></i>
                <i class="fa fa-star me-2"></i><i class="fa fa-star me-2"></i><i class="fa fa-star me-2"></i></i></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-0 pe-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="../index.php" style="background-color:#006" class="btn btn-primary px-3 d-none d-lg-block">Home</a>
        </div>
    </nav>
    <!-- Navbar End -->
   <style>
table
{
	background-image:url(../Assests/Icons/bgform2.jpg);
	color:#006;
