...
<head>
<h1 align="center">Rejected Work Requests</h1>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Rejected Work Requests</title>
</head>
<body>
<?php
  if(isset($_GET["acid"]))
  	...
  	if($con->query($del))
			...
			?>
					...
					<script>
							...
							alert("Work Accepted");
							window.location="RejectedWorkRequests.php";
					</script>
           <?php
